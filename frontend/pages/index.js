  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* ---- Hero Section ---- */}
          <div className="mt-20 sm:mt-28 text-center anim-fade-up">
            <h1
          ...
          {/* ---- Search Bar ---- */}
          <div className="mt-10 w-full max-w-xl anim-fade-up" style={{ animationDelay: "0.15s" }}>
            <form
          ...
          {/* ---- Stats Bar ---- */}
          <div className="mt-10 flex justify-center gap-8 sm:gap-14 anim-fade-up" style={{ animationDelay: "0.3s" }}>
            {STATS.map((s) => (
          ...
          {/* ---- How It Works ---- */}
          <div className="mt-16 w-full max-w-2xl anim-fade-up" style={{ animationDelay: "0.5s" }}>
          ...
          {/* ---- Example Questions ---- */}
          <div className="mt-14 w-full max-w-xl anim-fade-up" style={{ animationDelay: "0.6s" }}>
          ...
          {/* ---- Footer Disclaimer ---- */}
          <div className="mt-16 mb-10 anim-fade-up" style={{ animationDelay: "0.7s" }}>
